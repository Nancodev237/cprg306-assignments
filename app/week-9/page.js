...
/**
 * Landing page for week-9.
 * - Shows a GitHub login button when the user is not logged in.
 * - Shows a welcome message, logout button, and link to the
 *   shopping list when the user IS logged in.
 */
