export default function Item({ id, name, quantity, category }) {
  return (
    <li className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow-md dark:hover:shadow-gray-900 transition-shadow duration-200">
